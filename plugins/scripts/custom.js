    ...
    function _0x7231x8() {
        ...
        if (_0x7231x28["length"]) {
            ...
            if (_0x7231x29["length"]) {
                _0x7231x29["forEach"](function (_0x7231xa) {
                    var _0x7231x2a = new Splide("#" + _0x7231xa["id"], { type: "loop", autoplay: true, interval: 4000, perPage: 1 })["mount"]();
            ...
            if (_0x7231x2d["length"]) {
                _0x7231x2d["forEach"](function (_0x7231xa) {
                    var _0x7231x2e = new Splide("#" + _0x7231xa["id"], { type: "loop", autoplay: true, interval: 4000, arrows: false, perPage: 2 })["mount"]();
                });
            }
            var _0x7231x2f = document["querySelectorAll"](".tripple-slider");
            if (_0x7231x2f["length"]) {
                _0x7231x2f["forEach"](function (_0x7231xa) {
                    var _0x7231x30 = new Splide("#" + _0x7231xa["id"], { type: "loop", autoplay: true, padding: { left: "0px", right: "80px" }, interval: 4000, arrows: false, perPage: 2, perMove: 1 })["mount"]();
                });
            }
        }
        var _0x7231x31 = document["querySelectorAll"](".topic-slider");
        if (_0x7231x31["length"]) {
            var _0x7231x32 = new Splide(".topic-slider", { type: "loop", autoplay: false, padding: { left: "15px", right: "40px" }, arrows: false, perPage: 3, perMove: 1 })["mount"]();
        }
        var _0x7231x33 = document["querySelectorAll"](".user-slider");
        if (_0x7231x33["length"]) {
            var _0x7231x32 = new Splide(".user-slider", { type: "loop", autoplay: false, padding: { left: "0px", right: "40px" }, arrows: false, perPage: 4, perMove: 1 })["mount"]();
        }
        ...
        function _0x7231x5a() {
            ...
            if (/iP(hone|od|ad)/["test"](navigator["platform"])) {
                ...
                _0x7231x5b = { status: true, version: parseInt(_0x7231x5c[1], 10), info: parseInt(_0x7231x5c[1], 10) + "." + parseInt(_0x7231x5c[2], 10) + "." + parseInt(_0x7231x5c[3] || 0, 10) };
            } else {
                _0x7231x5b = { status: false, version: false, info: "" };
            }
            return _0x7231x5b;
        }
        ...
        if (_0x7231xc1["length"]) {
            ...
            var _0x7231xc4 = [["Sunday"], ["Monday", 9.0, 17.0], ["Tuesday", 9.0, 17.0], ["Wednesday", 9.0, 17.0], ["Thursday", 9.0, 17.0], ["Friday", 9.0, 17.0], ["Saturday", 9.0, 13.0]];
        ...
        function _0x7231x100() {
            ...
            if (document["querySelectorAll"](".shareToFacebook, .shareToTwitter, .shareToLinkedIn")[0]) {
                ...
                if (navigator["canShare"]) {
                    const _0x7231x105 = { title: _0x7231x101, text: _0x7231x102, url: _0x7231x103 };
            ...
            if (!_0x7231x150["classList"]["contains"]("isPWA")) {
                if ("serviceWorker" in navigator) {
                    window["addEventListener"]("load", function () {
                        navigator["serviceWorker"]["register"](_0x7231x7, { scope: _0x7231x6 })["then"](function (_0x7231x151) {
                            _0x7231x151["update"]();
                        });
                    });
                }
        ...
        let _0x7231x163 = [
            { id: "uniqueID", plug: "pluginName/plugin.js", call: "scripts/pluginName-call.js", style: "styles/pluginName-style.css", trigger: ".pluginTriggerClass" },
            { id: "chart", plug: "scripts/charts.js", call: "scripts/charts-call-charts.js", trigger: ".chart" },
            { id: "chart", plug: "scripts/charts.js", call: "scripts/charts-call-wallet.js", trigger: ".wallet-chart" },
            { id: "chart", plug: "scripts/charts.js", call: "scripts/charts-call-dashboard.js", trigger: ".dashboard-chart" },
            { id: "graph", plug: "scripts/charts.js", call: "scripts/charts-call-graphs.js", trigger: ".graph" },
            { id: "count", plug: "scripts/countdown.js", trigger: ".countdown" },
            { id: "gallery", plug: "scripts/glightbox.js", call: "scripts/glightbox-call.js", style: "styles/glightbox.css", trigger: "[data-gallery]" },
            { id: "gallery-views", plug: "galleryViews/gallery-views.js", trigger: ".gallery-view-controls" },
            { id: "filter", plug: "scripts/filterizr.js", call: "scripts/filterizr-call.js", style: "styles/filterizr.css", trigger: ".gallery-filter" },
            { id: "embedly", plug: "embedly/embedly.js", trigger: ".embedly-card" },
        ];
